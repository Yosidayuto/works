...
// コンストラクタ
//=============================================================================
CMapEdgeMask::CMapEdgeMask(int nPriority) : CPolygon3d(nPriority)
{
	m_nPatternAnim = 0;
	m_nCountAnim = 0;
}
...
// 生成処理
//=============================================================================
CMapEdgeMask * CMapEdgeMask::Create(D3DXVECTOR3 Pos, D3DXVECTOR3 Size)
{
	CMapEdgeMask *pFloor;

	pFloor = new CMapEdgeMask;
	if (pFloor != NULL)
	{
		pFloor->SetPos(Pos);
		pFloor->SetSize(Size);
...
// 初期化処理
//=============================================================================
HRESULT CMapEdgeMask::Init(void)
{
	//リソース確保
